...
class VisaApplicationController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'medical_report' => 'required|string|max:255',
            'attestation_details' => 'required|string|max:255',
    ...
    public function update(Request $request, VisaApplication $visaApplication)
    {
        $validated = $request->validate([
            ...
            'visa_number' => 'sometimes|required|string|max:255',
            
            'description' => 'sometimes|nullable|string|max:255',
            'appointment_date' => 'sometimes|required|date',
            'contract_person' => 'sometimes|required|string|max:255',
            'medical_report' => 'sometimes|required|string|max:255',
            'attestation_details' => 'sometimes|required|string|max:255',
